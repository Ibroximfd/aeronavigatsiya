...
import 'package:aeronavigatsiya/presentation/teachers/screens/library/create_chapter_page.dart';
import 'package:aeronavigatsiya/presentation/teachers/screens/library/edit_chapter_page.dart';
import 'package:aeronavigatsiya/presentation/teachers/screens/library/topic_list_page.dart';
...
void _confirmDelete(BuildContext context, String chapterId, String path) {
  showDialog(
    ...
    builder: (context) => AlertDialog(
      title: const Text('Bobni o‘chirish'),
      content: const Text('Bu bobni o‘chirishni xohlaysizmi?'),
      actions: [
        TextButton(
